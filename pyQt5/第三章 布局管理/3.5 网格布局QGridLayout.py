'''
当使用该布局管理器的时候，你可以把整个窗体想象成带有坐标的，
然后只用把各个控件放在相应的坐标就好了，请看示例(还是上方的登录框)：
'''

import sys
from PyQt5.QtWidgets import QApplication, QWidget, \
    QLabel, QLineEdit, QPushButton,QGridLayout, QVBoxLayout, QHBoxLayout
...
这里混合使用QVBoxLayout、QHBoxLayout和QGridLayout来完成布局。
    ...
    widget就是要添加的控件；row为第几行，0代表第一行；column为第几列，0代表第一列；
