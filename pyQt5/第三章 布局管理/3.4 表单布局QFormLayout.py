"""
表单布局可以将控件以两列的形式进行排布，左列控件为文本标签，
右列为输入型的控件，如QLineEdit。用这个布局管理器我们可以更加
快速方便地构写有表单的界面。我们用QFormLayout来改写下上面的代码：
"""

import sys
from PyQt5.QtWidgets import QApplication, QWidget, QLabel, \
    QLineEdit, QPushButton, QHBoxLayout, QVBoxLayout, QFormLayout
