...
class Demo(QWidget):
    ...
    def combobox_init(self):
        """
        addItem()方法是添加一个选项，而addItems()接收一个可循环参数，
        ...
        """
        当下拉框当前选项发生变化变化的话，
        则会触发序号变化currentIndexChanged信号和文本变化currentTextChanged信号，
        我们在这里进行了信号与槽的连接，注意槽函数是带参数的，
        所以我们用lambda表达式进行处理；
        """
    ...
    """
    在自定义的槽函数中，我们通过判断combobox的种类，若是self.combobox_1的话，则出现信息框，并且显示当前文本和及文本序号，
    currentIndex()方法获取当前文本序号，currentText()方法获取当前文本。若是self.combobox_2的话，
