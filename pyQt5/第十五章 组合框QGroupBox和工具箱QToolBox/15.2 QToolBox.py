...
class Demo(QToolBox):                                           # 1
    ...
    def toolbtn_init(self):                                     # 7
        self.toolbtn_f1.setIcon(QIcon('../QIconImg/15part/f1.ico'))
        self.toolbtn_f2.setIcon(QIcon('../QIconImg/15part/f2.ico'))
        self.toolbtn_f3.setIcon(QIcon('../QIconImg/15part/f3.ico'))
        self.toolbtn_m1.setIcon(QIcon('../QIconImg/15part/m1.ico'))
        self.toolbtn_m2.setIcon(QIcon('../QIconImg/15part/m2.ico'))
        self.toolbtn_m3.setIcon(QIcon('../QIconImg/15part/m3.ico'))
